...
export function SearchBar() {
  ...
  return (
    <div ref={searchRef} className="relative w-full max-w-xs md:max-w-sm lg:max-w-md">
      ...
      {isOpen && results.length > 0 && (
        <div className="absolute top-full mt-1 w-full bg-white dark:bg-slate-800 border border-gray-300 dark:border-slate-800 rounded-md shadow-lg max-h-96 overflow-y-auto">
