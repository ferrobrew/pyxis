...
# clang-cl + xwin-provisioned MSVC headers/libs (x86_64). Not part of pyxis codegen
...
# Usage:
#   cmake -S . -B build \
#     -DCMAKE_TOOLCHAIN_FILE=<pyxis-repo>/tools/cmake-toolchains/xwin-x64.cmake \
...
set(CLANG_TARGET "--target=x86_64-pc-windows-msvc")
...
set(_XWIN_LIB "/libpath:${XWIN_ROOT}/crt/lib/x86_64 /libpath:${XWIN_ROOT}/sdk/lib/ucrt/x86_64 /libpath:${XWIN_ROOT}/sdk/lib/um/x86_64")
